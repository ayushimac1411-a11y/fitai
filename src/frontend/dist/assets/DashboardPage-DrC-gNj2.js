import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, R as React, a as clsx, b as cn, d as commonjsGlobal, g as getDefaultExportFromCjs, o, u as useStore, m as motion, A as Activity, D as Dumbbell, F as Flame, C as ChartColumn, Z as Zap } from "./index-gvkJDNXI.js";
...
var getAttrsOfPolarLabel = function getAttrsOfPolarLabel2(props) {
  ...
  var _polarToCartesian2 = polarToCartesian(cx2, cy, r, midAngle), x2 = _polarToCartesian2.x, y2 = _polarToCartesian2.y;
  return {
    x: x2,
    y: y2,
    textAnchor: "middle",
...
var parseViewBox = function parseViewBox2(props) {
  var cx2 = props.cx, cy = props.cy, angle = props.angle, startAngle = props.startAngle, endAngle = props.endAngle, r = props.r, radius = props.radius, innerRadius = props.innerRadius, outerRadius = props.outerRadius, x2 = props.x, y2 = props.y, top = props.top, left = props.left, width = props.width, height = props.height, clockWise = props.clockWise, labelViewBox = props.labelViewBox;
  if (labelViewBox) {
    return labelViewBox;
  }
...
function buildWeekChart(checkIns) {
  const today = /* @__PURE__ */ new Date();
  const monday = new Date(today);
  monday.setDate(today.getDate() - (today.getDay() + 6) % 7);
  return WEEKDAYS.map((d2, i) => {
    const date2 = new Date(monday);
    date2.setDate(monday.getDate() + i);
    const iso = date2.toISOString().split("T")[0];
    const found = checkIns.find((c2) => c2.date === iso);
    return { day: d2, done: (found == null ? void 0 : found.workoutDone) ? 1 : 0, future: date2 > today };
  });
}
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      style: glow ? { boxShadow: `0 0 20px ${glow}` } : void 0,
      children: [
...
function SkeletonCard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-glass p-4 space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-24 bg-white/5" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-16 bg-white/5" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-2 w-20 bg-white/5" })
  ] });
}
function EmptyState({
  message,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8 space-y-3", children: [
...
function BMIScaleBar({ bmi }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between text-[10px] text-muted-foreground px-0.5", children: zones.map((z) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: z.color }, children: z.label }, z.label)) })
  ] });
}
...
function DashboardPage() {
  ...
  const displayName = (profile == null ? void 0 : profile.name) ?? (userProfile == null ? void 0 : userProfile.fullName) ?? "Athlete";
  const firstName = displayName.split(" ")[0];
  const weightEntries = weightQuery.data ?? [];
  const checkIns = checkInsQuery.data ?? [];
  const streak = Number(streakQuery.data ?? 0);
  const latestWeight = ((_a = weightEntries[0]) == null ? void 0 : _a.weightKg) ?? (profile == null ? void 0 : profile.weightKg) ?? null;
  const heightCm = (profile == null ? void 0 : profile.heightCm) ?? (userProfile == null ? void 0 : userProfile.heightCm) ?? 0;
  const bmi = latestWeight && heightCm ? calculateBMI(latestWeight, heightCm) : null;
  const workoutsThisWeek = checkIns.filter((c2) => c2.workoutDone).length;
  const weightChartData = [...weightEntries].reverse().map((e3) => ({ date: fmtDate(e3.date), weight: e3.weightKg }));
  ...
  const quickActions = [
    ...
    {
      label: "AI Plan",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 15 }),
      tab: "ai-plans",
      ocid: "dashboard.ai_plan_button"
    },
    {
      label: "Exercises",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { size: 15 }),
      tab: "exercises",
      ocid: "dashboard.exercises_button"
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-6 space-y-5 pb-28", "data-ocid": "dashboard.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-2xl font-display font-bold text-foreground leading-tight", children: [
            getGreeting(),
            ", ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: firstName }),
            "!"
          ] }),
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: [0, 1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonCard, {}, i)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Scale, { size: 16, className: "text-secondary" }),
              label: "Weight",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  size: 16,
                  className: bmi ? getBMIColor(bmi.category) : "text-muted-foreground"
                }
              ),
              label: "BMI",
              value: bmi ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: getBMIColor(bmi.category), children: bmi.value }) : "—",
              sub: (bmi == null ? void 0 : bmi.category) ?? "Set profile first",
              delay: 0.14,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { size: 16, className: "text-accent" }),
              label: "Workouts",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              ...
              glow: streak > 0 ? "rgba(251,146,60,0.12)" : void 0
            }
          )
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: quickActions.map(({ label, icon, tab, ocid }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            "data-ocid": ocid,
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-medium text-muted-foreground", children: label })
            ]
          },
          tab
        ))
    ...
    !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        title: "BMI Overview",
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Scale, { size: 16, className: "text-accent" }),
        delay: 0.34,
        ocid: "dashboard.bmi_card",
        children: bmi ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: bmi.message }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(BMIScaleBar, { bmi: bmi.value })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          EmptyState,
          {
    ...
    isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-28 bg-white/5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-24 bg-white/5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-full bg-white/5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-3/4 bg-white/5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full rounded-full bg-white/5" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        title: "Weight Trend",
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 16, className: "text-secondary" }),
        delay: 0.4,
        ocid: "dashboard.weight_chart",
        children: weightChartData.length > 1 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 180, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          AreaChart,
          {
            data: weightChartData,
            margin: { top: 4, right: 4, left: -20, bottom: 0 },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "weightGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(DarkTooltip, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Area,
                {
                  type: "monotone",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Section,
      {
        ...
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { size: 16, className: "text-accent" }),
        delay: 0.46,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 140, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            BarChart,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { hide: true, domain: [0, 1] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(DarkTooltip, {}) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "done", radius: [6, 6, 0, 0], children: weekChartData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Cell,
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-2 text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2.5 h-2.5 rounded-sm bg-accent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Completed" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2.5 h-2.5 rounded-sm bg-white/10 ml-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Missed / Upcoming" })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        title: "Macro Split",
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { size: 16, className: "text-purple-400" }),
        delay: 0.52,
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: 130, height: 130, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Pie,
              {
                ...
                paddingAngle: 3,
                dataKey: "value",
                children: MACRO_DATA.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Cell,
                  {
                    fill: MACRO_COLORS[MACRO_DATA.indexOf(m2)]
                  },
                  `macro-${m2.name}`
                ))
              }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-2", children: [
            MACRO_DATA.map((m2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: m2.name })
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground pt-1 leading-relaxed", children: "Based on your fitness goal. Adjust in your AI plan." })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      {
        title: "Today's Focus",
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 16, className: "text-accent" }),
        delay: 0.56,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5", children: [
            {
              ...
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { size: 13 })
            },
            { label: "Follow your meal plan", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { size: 13 }) },
            { label: "Drink 8 glasses of water", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { size: 13 }) },
            { label: "Log your progress", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 13 }) }
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full border border-accent/30 flex items-center justify-center flex-shrink-0 text-accent", children: item.icon }),
    ...
    hasNoData && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground", children: "Ready to start?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs mx-auto", children: "Set up your profile to unlock your personalised BMI, AI plans, and progress tracking." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
